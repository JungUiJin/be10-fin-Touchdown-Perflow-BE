...
| 정의진 |부트캠프 과정의 마지막 프로젝트를 진행하며 많은것을 얻을 수 있었던 것 같습니다. Spring Security + JWT를 이용한 인증/인가 기능을 구현하고, Restful 기반의 API 개발, SPA 기반의 Vue 페이지 제작 등 저에게 도움이 되는 많은 경험을 할 수 있었습니다. 특히 CI/CD 과정을 직접 설계하고 구현하며 AWS를 사용하는 클라우드 방식의 배포, 그 중에서도 EKS Cluster와 ArgoCD를 활용한 배포 과정 구현은 Kubernetes에 대한 이해에 많은 도움이 되었고 어려움도 많았지만 즐거운 경험이었습니다. 마지막으로 팀장으로써 우유부단하고, 답답한 모습이 자주 보였을 것 같은데 팀원분들 께서 많이 도와주셔서 무사히 프로젝트를 마칠 수 있었던 것 같습니다.|
